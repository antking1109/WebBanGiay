            ...
            <div class="box box-info">
                <div class="box-body">
                    <form role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Tiêu đề</label>
                            <input type="text" class="form-control" placeholder="Nhập tiêu đề hình ảnh..." name="txtTitle" value="<?php echo e(old('txtTitle')); ?>">
                        </div>
                        <div class="form-group">
                            <label>Mô tả</label>
                            <textarea class="form-control" rows="3" placeholder="Nhập mô tả hình ảnh ..." name="txtAlt"><?php echo e(old('txtAlt')); ?></textarea>
                        </div>
